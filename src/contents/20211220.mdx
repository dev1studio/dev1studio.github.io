...
<figure>
  <picture>
    <source srcSet={`/0/20211220/stop-it.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/0/20211220/stop-it.jpeg?${uuidv4()}`} alt='' />
  </picture>
...
<figure>
  <picture>
    <source srcSet={`/0/20211220/mafia.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/0/20211220/mafia.jpeg?${uuidv4()}`} alt='' />
  </picture>
  <figcaption>열린 결말</figcaption>
</figure>
