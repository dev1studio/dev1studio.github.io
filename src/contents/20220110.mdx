...
- Redux, Recoil(Facebook에서 개별) 등을 이용해 상태관리 가능 (npm, yarn 패키지)
...
<figure>
  <picture>
    <source srcSet={`/0/20220110/shut-up-babe.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/0/20220110/shut-up-babe.jpg?${uuidv4()}`} alt='' />
  </picture>
  <figcaption>윈도우즈는 짜져있어</figcaption>
</figure>
