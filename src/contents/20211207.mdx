...
<small>이기는 놈이 내 편</small>
<time>2021.12.07</time>
<picture>
  <source srcSet={`/20211207/summary.webp?${uuidv4()}`} type="image/webp" />
  <img src={`/20211207/summary.png?${uuidv4()}`} alt='' />
</picture>
...
<figure>
  <picture>
    <source srcSet={`/20211207/emotion-win.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/20211207/emotion-win.jpeg?${uuidv4()}`} alt='' />
  </picture>
...
<figure>
  <picture>
    <source srcSet={`/20211207/css-win.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/20211207/css-win.jpeg?${uuidv4()}`} alt='' />
  </picture>
...
<figure>
  <picture>
    <source srcSet={`/20211207/cat.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/20211207/cat.jpeg?${uuidv4()}`} alt='' />
  </picture>
