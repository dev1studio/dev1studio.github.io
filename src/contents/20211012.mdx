...
<figure>
  <picture>
    <source srcSet={`/0/20211012/followme.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/0/20211012/followme.jpeg?${uuidv4()}`} alt='' />
  </picture>
...
<figure>
  <picture>
    <source srcSet={`/0/20211012/losse.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/0/20211012/losse.jpeg?${uuidv4()}`} alt='' />
  </picture>
