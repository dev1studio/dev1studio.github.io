...
__React와 RN 사이의 차이점이 없습니다.__ *성*동일
...
<figure>
  <iframe
    ...
    src="https://www.youtube.com/embed/779jxjHopk0"
...
<figure>
  <picture>
    <source srcSet={`/0/20211211/easy.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/0/20211211/easy.jpeg?${uuidv4()}`} alt='' />
  </picture>
