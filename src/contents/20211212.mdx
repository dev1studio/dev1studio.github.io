...
<figure>
  <picture>
    <source srcSet={`/0/20211212/question.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/0/20211212/question.jpeg?${uuidv4()}`} alt='' />
  </picture>
...
일단 <LinkButton href='https://brew.sh/index_ko'>Homebrew 공식홈</LinkButton> 접속해서 안내된 방법으로 설치합니다.
