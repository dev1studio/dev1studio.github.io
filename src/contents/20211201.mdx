...
<small>부제: 재귀적 inherit의 굴레</small>
<time>2021.12.01</time>
<picture>
  <source srcSet={`/20211201/summary.webp?${uuidv4()}`} type="image/webp" />
  <img src={`/20211201/summary.png?${uuidv4()}`} alt='' />
</picture>
...
<figure>
  <picture>
    <source srcSet={`/20211201/headattact.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/20211201/headattact.jpeg?${uuidv4()}`} alt='' />
  </picture>
