...
<figure>
  <picture>
    <source srcSet={`/0/20211231/bodap.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/0/20211231/bodap.png?${uuidv4()}`} alt='' />
  </picture>
  <figcaption>보답할 기회는 주세요 부처님 하나님 알라신...</figcaption>
</figure>
...
<figure>
  <picture>
    <source srcSet={`/0/20211231/mu.webp?${uuidv4()}`} type="image/webp" />
    <img src={`/0/20211231/mu.png?${uuidv4()}`} alt='' />
  </picture>
  <figcaption>무계획이 계획</figcaption>
</figure>
