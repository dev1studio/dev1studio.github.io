  ...
  return (
    <Container>
      ...
      <main className={styles['mainPage']}>
        ...
        <ul>
          {posts.filter(post => post.category === 'Street Code Fighters').slice(offset, offset + limit).map(post =>
            <li key={post.id}>
        ...
        <Pagination
          total={posts.filter(post => post.category === 'Street Code Fighters').length}
          limit={limit}
          page={page}
          setPage={setPage}
        />
