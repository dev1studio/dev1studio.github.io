...
const posts = [
  ...
  {
    id: uuidv4(),
    thumbnail: "/0/20220204/summary",
    subject: "Angular, React, Svelte 그리고 Vue로 스타일링 해볼까?",
    category: "Comparative Frameworks",
    url: "/20220204",
    datetime: "2022.02.04",
    badge: false,
    description: "이번 글에서는 Angular, React, Svelte, 그리고 Vue에서는 어떻게 스타일링 코드를 작성해야하는지, CSS 파일은 어떻게 작성해야하는지 알려드립니다.",
  },
  {
    id: uuidv4(),
    thumbnail: "/0/20220113/summary",
    subject: "Angular, React, Svelte 그리고 Vue를 이용해 개발 찍먹해보기",
    category: "Comparative Frameworks",
    url: "/20220113",
    datetime: "2022.01.13",
    badge: false,
    description: "Angular, React, Svelte, 그리고 Vue로는 어떻게 개발할까요? CSS 작업은요? 4가지 프레임워크 모두를 찍먹하기 위해서는 일단 집중력이 필요합니다. 찍먹이지만 글이 약간 긴 관계로 집중 빡! 해주세요",
  },
  {
    id: uuidv4(),
    thumbnail: "/0/20220112/summary",
    subject: "Angular, React, Svelte 그리고 Vue를 시작해볼까요?",
    category: "Comparative Frameworks",
    url: "/20220112",
    datetime: "2022.01.12",
    badge: false,
    description: "Angular, React, Svelte, 그리고 Vue를 macOS에서 시작해 봅시다!",
  },
  {
    id: uuidv4(),
    thumbnail: "/0/20220110/summary",
    subject: "Angular, React, Svelte 그리고 Vue의 장단점",
    category: "Comparative Frameworks",
    url: "/20220110",
    datetime: "2022.01.10",
    badge: false,
    description: "Angular, React, Svelte, 그리고 Vue의 장단점을 알려드리겠습니다",
  },
  {
    id: uuidv4(),
    thumbnail: "/0/20220105/summary",
    subject: "Angular, React, Svelte, 그리고 Vue의 간단 비교",
    category: "Comparative Frameworks",
    url: "/20220105",
    datetime: "2022.01.05",
    badge: false,
    description: "Angular, React, Svelte, 그리고 Vue의 차이점을 간단히 비교해 보도록 할게요",
  },
  {
    id: uuidv4(),
